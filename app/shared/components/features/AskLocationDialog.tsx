...
export default function AskLocationDialog(props: AskLocationDialogProps) {
    ...
    return (
        <div id="ask-location-dialog" className="relative z-10 hidden" aria-labelledby="modal-title" role="dialog"
             aria-modal="true">
                        ...
                        <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                            <div className="sm:flex sm:items-start">
                                <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                    <h3 className="text-base font-semibold leading-6 text-gray-900" id="modal-title">Ort
                                        der
                                        Trainingseinheit</h3>
                                    <div className="mt-2">
                                        ...
                                        <div className="m-2 w-full">
                                            <div className="m-2">
                                                <label htmlFor="gyms"
                                                       className="block mb-2 text-sm text-left font-medium text-gray-900 dark:text-white">Ort</label>
                                                <select
                                                    id="gyms"
                                                    onChange={(e: any) => {
